...
function cardShell(item,body){
  ...
  return '<article class="mb-card">'+
    ...
    '<div class="mb-card-head"><div class="mb-icon">'+(draft.type==='drink'?'🧋':draft.type==='production'?'🧑‍🍳':'⏳')+'</div><div><h2>'+esc(item.name)+'</h2>'+en+'</div></div>'+
    body+'</article>';
}
...
.mb-card{border:1px solid #cfe3d8;border-radius:16px;padding:12px;background:#fbfefc;overflow:hidden;min-height:0;display:flex;flex-direction:column}.mb-card-head{display:flex;gap:8px;align-items:center;margin-bottom:8px}.mb-icon{width:34px;height:34px;border-radius:10px;background:#e5f4ec;display:grid;place-items:center;font-size:18px;flex:none}.mb-card h2{font-size:16px;line-height:1.22;margin:0;color:#164b38}.mb-en{font-size:9px;color:#738a80;margin-top:2px}.mb-img{height:92px;margin:-2px -2px 9px;border-radius:11px;overflow:hidden;background:#eef6f2}.mb-img img{width:100%;height:100%;object-fit:cover}
